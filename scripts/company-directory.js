...
const JSDELIVR = 'https://cdn.jsdelivr.net/gh/ryanwalker64/talent-engine@v1.3.9.2/'
...
function openRoles(company) {
    ...
    const roles = company.fields['Live Job Records'] ? company.fields['Live Job Records'] : ''
    if(roles) {
        // console.log(roles)
        if(roles.length > 1) {
